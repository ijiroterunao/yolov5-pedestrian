...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_pedestrian.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/pedestrian.yaml', help='data.yaml path')
